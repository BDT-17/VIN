...
def write_manifest(rows, output_dir=OUTPUT_DIR):
    ...
    fieldnames = [
        ...
        "generation_mode", "lora_enabled", "lora_path", "lora_weight_name", "lora_adapter_name", "lora_scale", "lora_fuse", "lora_trigger_token", "lora_prompt_prefix", "insert_bbox", "patch_bbox", "patch_debug_path",
