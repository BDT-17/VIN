...
\begin{itemize}
    ...
    \item If acceptance $< 60\%$ after parameter sweep: continue pipeline-level refinement, including confidence scheduling, retry-policy tuning, insertion-guide geometry, and stricter variant-wise quality analysis.
\end{itemize}
